...
- [x] Final regression/archive checks and revised downloadable Reconquista 1.8.4 tester bundle.
- [x] Prepare source and store PR update for 1.8.4 (base 3.0.7), including TL;DR
