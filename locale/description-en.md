...
Supported native shooters (see README.md): interval follows the firing animation without shortening it. sync_to_animation: false restores the independent timer. Start a new match after upgrading.
